...
|                       | `PROTON_ENABLE_HDR`            | Enable HDR (requires HDR-capable compositor, game and monitor). Does not enable Wayland; outside gamescope combine with `PROTON_ENABLE_WAYLAND=1`. |
